...
$questions = [
    ...
    [
        "question" => "Identify the next image in the sequence:",
    ...
    [
        "question" => "What comes next in the sequence: 5, 10, 20, 40, ___?",
        "options" => ["80", "90", "100", "70"],
        "answer" => "A"
    ],
    [
        "question" => "Which number completes the pattern: 2, 4, 8, 16, 32, ___?",
        "options" => ["64", "48", "56", "40"],
        "answer" => "A"
    ],
    [
        "question" => "What is the missing shape in this sequence?",
        "options" => ["Shape A", "Shape B", "Shape C", "Shape D"],
        "answer" => "D"
    ],
    [
    ...
    [
        "question" => "What comes next in the sequence: A, C, E, G, ___?",
        "options" => ["H", "I", "J", "K"],
        "answer" => "A"
    ],
    [
        "question" => "Which pattern follows this sequence?",
        "options" => ["Pattern A", "Pattern B", "Pattern C", "Pattern D"],
        "answer" => "B"
    ],
    [
        "question" => "What is the next number in the pattern: 13, 17, 21, 25, ___?",
        "options" => ["29", "31", "33", "27"],
        "answer" => "A"
    ],
    [
        "question" => "Which shape fits the pattern?",
        "options" => ["Shape A", "Shape B", "Shape C", "Shape D"],
        "answer" => "B"
    ],
    [
        "question" => "What is the missing number: 11, 22, 33, 44, ___?",
        "options" => ["55", "66", "77", "88"],
        "answer" => "A"
    ]
];
