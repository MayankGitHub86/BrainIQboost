...
<head>
 ...
 <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="firststyle.css?v=<?php echo time(); ?>">
...
<body>
    <header>
        <nav>
            ...
            <ul type="none" style="display: flex; font-family: 'Inter', sans-serif;">
                <li style="margin-left: 20px;"><a href="firstindex.php" style="text-decoration: none;" class="li-a">Home</a></li>
                <li style="margin-left: 20px;"><a href="#about" style="text-decoration: none;" class="li-a">About</li>
                <li style="margin-left: 20px;"><a class="li-a" href="faq.php" style="text-decoration: none;">FAQ</a></li>
                <li style="margin-left: 20px;"><a href="#contact" style="text-decoration: none;" class="li-a">Contact</a></li>
                <li style="margin-left: 20px;"><a href="auth.php" style="text-decoration: none;" class="li-a">Login</a></li>
    ...
    <section class="section-4">
        <div class="d-4">
            ...
            <button><a href="secondpage.php" style="color: white;"  onclick="hmm()">Take the Test Now</a></button>
        </div>
    </section>
    ...
    <footer style="display: flex;"  id="contact">
        ...
        <div class="d-f">
            <div class="d-f-1">
                <ul>Quick Links
                    <li style="margin-top: 20px;" onclick="window.location.href='firstindex.php'">Home</li>
                    <li  onclick="window.location.href='#about'">About</li>
                    <li onclick="window.location.href='Faq.php'">FAQ</li>
    ...
    <script>
    function hmm() {
        alert("hello, If you are not login then please login");
    }
    </script>
